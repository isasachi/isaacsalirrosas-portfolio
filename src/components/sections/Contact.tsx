          ...
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/3">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  <svg className="w-6 h-6 text-primary mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              ...
              <div className="mt-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <a 
                    href="https://linkedin.com/in/isaacsalirrosas" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-gray-600 hover:text-primary transition-colors"
                  >
                  ...
                  <a 
                    href="https://twitter.com/isaacsalirrosas" 
                    target="_blank" 
                    rel="noopener noreferrer"
                    className="text-gray-600 hover:text-primary transition-colors"
                  >
            ...
            <div className="md:w-2/3">
              ...
              <form ref={form} onSubmit={handleSubmit}>
                ...
                {submitMessage && (
                  <p className={`mt-4 ${submitError ? 'text-red-600' : 'text-green-600'}`}>{submitMessage}</p>
                )}
              </form>
            </div>
          </div>
